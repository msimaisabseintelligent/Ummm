...
import { XIcon, Database, Download, Upload, Cloud, Layout, Layers, LogOut, Trash, Send } from './Icons';
          ...
          <div className="flex-1 overflow-y-auto p-5 space-y-8">
                            ...
                            <div className="flex items-center justify-between text-xs px-1">
                                {isGuest ? (
                                    ...
                                    <div className="flex items-center gap-1.5">
                                        {syncStatus === 'syncing' && <span className="w-1.5 h-1.5 rounded-full bg-yellow-500 animate-pulse" />}
                                        {syncStatus === 'synced' && <span className="w-1.5 h-1.5 rounded-full bg-green-500" />}
                                        {syncStatus === 'error' && <span className="w-1.5 h-1.5 rounded-full bg-red-500" />}
            ...
            <section>
                ...
                <div className="space-y-2">
                    ...
                    >
                        <span className="flex items-center gap-3">
                            <Send className="w-4 h-4 text-gray-400 group-hover:text-green-500" />
